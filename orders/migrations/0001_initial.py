# Generated by Django 3.1.7 on 2021-06-04 20:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('business', '0012_businesstype_icon'),
        ('customers', '0006_auto_20210603_1418'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_type', models.IntegerField(choices=[(0, 'from list'), (1, 'custom order')])),
                ('description', models.TextField(blank=True, null=True)),
                ('custom_offer', models.DecimalField(decimal_places=2, help_text='A total price offer for custom order.', max_digits=10)),
